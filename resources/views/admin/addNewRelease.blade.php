...
@section('header_title')Add New Release @stop
@section('content')
    <div class="content">
        <div class="container">
                            ...
                            <div class="col-md-12">
                                <form method="post" action="{{route('addNewReleaseProcess')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="p-20">
                                        ...
                                        <div class="m-t-20">
                                            <h5><b>Free Download link</b></h5>
                                            <input type="text" class="form-control" name="free_download" id="moreoptions" />
                                        </div>
                                    </div>
