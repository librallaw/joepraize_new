!function (a) {
    ...
    function b(b) {
        ...
        a("#" + b + " .form-control").each(function () {
            var b = a(this).attr("name"), d = a(this).val();
            return a(this).css({border: "1px solid #c4c4c4"}), a(this).prop("required") && "" == d ? (a(this).css({border: "2px solid red"}), a(this).focus(), !1) : void("" == !d && c.push("&" + b + "=" + d))
        });
        var d = c.join(" ");
        a.ajax({
            method: "POST",
    ...
    if (a(".har_logo_eq span").each(function () {
            function c() {
                b.animate({height: Math.floor(100 * Math.random()) + "%"}, 350)
            }

            var b = a(this);
            setInterval(c, 350)
        }), a(".har_firefly").length > 0 && a(".har_firefly").each(function () {
            var b = a(this).attr("data-total"), c = a(this).attr("data-minPixel"), d = a(this).attr("data-maxPixel");
            a.firefly({minPixel: c, maxPixel: d, color: "none", total: b, on: ".har_firefly"})
            ...
            var b = 0, c = 50, d = Math.floor(Math.random() * (c - b + 1) + b);
            a(this).css("transition-delay", "0." + d + "s")
        }), a(".har_countdown").each(function () {
            var b = a(this).attr("data-year"), c = a(this).attr("data-month"), d = a(this).attr("data-day");
            a(this).countdown({until: new Date(b, c - 1, d)})
        }), a(".har_timer").appear(function () {
            var b = a(this);
            b.countTo({from: 0, to: b.html(), speed: 1300, refreshInterval: 60})
        ...
        var c = new Instafeed({
            get: "user",
            userId: 404535611,
            accessToken: "404535611.1677ed0.96e80940478048e4b2776cc63f52752e",
            sortBy: "most-recent",
    ...
    var cd = new Instafeed({
        get: "user",
        userId: 1539272220,
        accessToken: "1539272220.1677ed0.bab5cf8dc76e4ea1884455023d1b4e7b",
        sortBy: "random",
        template: '  <div class="col-sm-4 har_portfolio_item grid-item event"><div class="har_portfolio_item_cont"><img src="{{image}}" alt="" class="img-responsive"><span class="har_port_titles"> <span class="har_port_icons"> <a href="#"><i class="ti ti-link"></i></a> <a href="{{image}}" class="lightbox"><i class="ti ti-search"></i></a></span></span></div></div>',
        target: "all_p",
        limit: 6,
        resolution: "standard_resolution"
    });
    ...
    a(".har_slider_carousel").owlCarousel({
        ...
        var b = a(this).attr("data-image"), c = a(this).attr("data-gradient"), d = a(this).attr("data-color"), e = a(this).attr("data-blend"), f = a(this).attr("data-opacity"), g = a(this).attr("data-position"), h = a(this).attr("data-height");
        ...
        var b = a(this).attr("data-color"), c = a(this).attr("data-image"), d = a(this).attr("data-opacity"), e = a(this).attr("data-blend");
        ...
        var c = a(this);
        a("html, body").stop().animate({scrollTop: a(c.attr("href")).offset().top}, 300), b.preventDefault()
        ...
        var c = a(this).parents(".add-to-cart").find(".qty").val(), d = 1 * c + 1;
    ...
    a("#nav-sidebar").onePageNav({
        ...
        if (a(".har_mobile_menu").trigger("click"), a(".har_top_menu_cont a[href*=\\#]:not([href=\\#])").removeClass("active"), a(this).addClass("active"), location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") || location.hostname == this.hostname) {
            var b = a(this.hash);
            if (b = b.length ? b : a("[name=" + this.hash.slice(1) + "]"), b.length)return a("html,body").animate({scrollTop: b.offset().top}, 1e3), !1
        }
    ...
    jQuery("#jquery_jplayer_main").jPlayer({
        ready: function () {
            if (jQuery(".playlist-wrapper .jp-playlist .trak-item").length > 0) {
                var a = jQuery(".playlist-wrapper .jp-playlist .about-list").next(), b = a.data("audio"), c = a.find("audio").attr("title"), d = a.data("thumbnail"), e = a.data("artist");
                jQuery(".jp-audio-main .har-artist").text(e), jQuery(".jp-audio-main .har-thumbnail img").attr("src", d), a.addClass("active"), a.find("audio").attr("data-state", "pause"), jQuery(".jp-jplayer").attr({
                    "data-state": "pause",
                    "data-audio-src": b
                }), jQuery("#jquery_jplayer_main").jPlayer("setMedia", {title: c, m4a: b})
            }
        },
        ...
        ended: function () {
            ...
            if (a.next().length > 0) {
                var b = a.next(), c = b.find("audio").attr("title"), d = b.data("audio"), e = b.data("thumbnail"), f = b.data("artist");
    ...
    var h = {
        init: function () {
            jQuery(".trak-item .play-pause-button").on("click", function () {
                ...
                var a = jQuery(this).parent(), b = a.find("audio").attr("title"), c = a.data("audio"), d = a.data("thumbnail"), f = (a.data("artist"), jQuery('.trak-item.active[data-audio="' + c + '"][data-artist="' + i + '"][data-thumbnail="' + d + '"]')), g = jQuery(this).parent().find("audio").attr("data-state"), h = jQuery(".jp-jplayer").attr("data-audio-src");
                if (h == c) {
                    if ("play" == g)if (a.hasClass("active"))jQuery("#jquery_jplayer_main").jPlayer("pause"), a.removeClass("playing"), a.find("audio").attr("data-state", "pause"), jQuery(".jp-jplayer").attr("data-state", "pause"), f.addClass("active"), f.removeClass("playing"); else {
                    ...
                    } else if ("pause" == g)if (a.hasClass("active"))jQuery("#jquery_jplayer_main").jPlayer("play"), a.addClass("playing"), a.find("audio").attr("data-state", "play"), jQuery(".jp-jplayer").attr("data-state", "play"), f.addClass("active playing"); else {
                        jQuery(".trak-item").removeClass("active playing"), a.addClass("active playing");
                        var i = a.data("artist");
                        jQuery(".jp-audio-main .har-artist").text(i), jQuery("#jquery_jplayer_main").jPlayer("setMedia", {
                            title: b,
            ...
            jQuery(".har-prev").on("click", function () {
                var a = jQuery(".trak-item.active");
                if (a.prev().length > 0) {
                    var b = a.prev(), c = b.find("audio").attr("title"), d = b.data("audio"), e = b.data("thumbnail"), f = b.data("artist");
                    jQuery(".jp-jplayer").attr("data-state");
                    jQuery(".jp-audio-main .har-artist").text(f), jQuery(".trak-item").removeClass("active playing"), b.addClass("active playing"), jQuery(".har-thumbnail img").attr("src", e), jQuery("#jquery_jplayer_main").jPlayer("setMedia", {
                        title: c,
                        m4a: d
    ...
    var b = $(".grid").isotope({itemSelector: ".grid-item", percentPosition: !0, masonry: {columnWidth: ".grid-item"}});
    b.imagesLoaded().progress(function () {
        b.isotope("layout")
    }), $(window).resize(function () {
        b.isotope("layout")
    }), $(".masonry").masonry({itemSelector: ".masonry-item"}), $(".filter-button-group").on("click", "a", function () {
